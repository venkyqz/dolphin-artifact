...
class AbstractAgentHook:
    ...
    def on_stage_start(self, *, stage: "MultiStageAgent.StageMarker"):
        ...

    def on_stage_stop(self, *, trajectory: Trajectory, info: AgentInfo, stage: "MultiStageAgent.StageMarker"):
        ...
...
class CombinedAgentHook(AbstractAgentHook):
    ...
    def on_stage_start(self, *, stage: "MultiStageAgent.StageMarker"):
        for hook in self.hooks:
            hook.on_stage_start(stage=stage)

    def on_stage_stop(self, *, trajectory: Trajectory, info: AgentInfo, stage: "MultiStageAgent.StageMarker"):
        for hook in self.hooks:
            hook.on_stage_stop(trajectory=trajectory, info=info, stage=stage)
